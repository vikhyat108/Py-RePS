...
executable = "./class"
parameter_file = "parameters_1F_class.ini"
...
file = open(Class/"output_1F/_z1_tk.dat", "r")
k = np.genfromtxt(Class/"output_1F/_z1_tk.dat", usecols=0)
db = np.genfromtxt(Class/"output_1F/_z1_tk.dat", usecols=2)
dc = np.genfromtxt(Class/"output_1F/_z1_tk.dat", usecols=3)
dn = np.genfromtxt(Class/"output_1F/_z1_tk.dat", usecols=6)
knum = len(k)

file = open(Class/"output_1F/_z2_tk.dat", "r")
dbplus = np.genfromtxt(Class/"output_1F/_z2_tk.dat", usecols=2)
dcplus = np.genfromtxt(Class/"output_1F/_z2_tk.dat", usecols=3)
dnplus = np.genfromtxt(Class/"output_1F/_z2_tk.dat", usecols=6)

file = open(Class/"output_1F/_z3_tk.dat", "r")
dbminus = np.genfromtxt(Class/"output_1F/_z3_tk.dat", usecols=2)
dcminus = np.genfromtxt(Class/"output_1F/_z3_tk.dat", usecols=3)
dnminus = np.genfromtxt(Class/"output_1F/_z3_tk.dat", usecols=6)
...
for j in range(1,50):
	file = open(Class/f"output_1F/_z{j+3}_tk.dat", "r")
	k = np.genfromtxt(Class/f"output_1F/_z{j+3}_tk.dat", usecols=0)
	dbminus = np.genfromtxt(Class/f"output_1F/_z{j+3}_tk.dat", usecols=2)
	dcminus = np.genfromtxt(Class/f"output_1F/_z{j+3}_tk.dat", usecols=3)
	dnminus = np.genfromtxt(Class/f"output_1F/_z{j+3}_tk.dat", usecols=6)
	
	file = open(Class/f"output_1F/_z{j+4}_tk.dat", "r")
	dbplus = np.genfromtxt(Class/f"output_1F/_z{j+4}_tk.dat", usecols=2)
	dcplus = np.genfromtxt(Class/f"output_1F/_z{j+4}_tk.dat", usecols=3)
	dnplus = np.genfromtxt(Class/f"output_1F/_z{j+4}_tk.dat", usecols=6)
...
for i in range(0,knum):
	...
	file_2.write('	'+str(k[i])+'	'+str(tk_c)+'	'+str(tk_b)+'	'+str(0.0)+'	'+str(0.0)+'	'+str(0.0)+'	'+str(1.0)+'\n')
	file_3.write('	'+str(k[i])+'	'+str(growth_m_99)+'\n')
	
	

########	Hubble in format of ICs for Gadget-3
H = open("./1F_ICs/Hz.txt","w")
z_nstep = 1000
